    ...
    <div v-if="isSuccessful">
        <div class="container content">
            ...
            <div class="text">
                ...
                <div>
                    <p>
                        Votre paiement a bien été accepté, votre offre de projet
                        devrait être visible sur la plateforme dans quelques
                        minutes.
                    </p>
                    <p>
    ...
    <div v-else>
        <div class="container content">
            ...
            <div class="text">
                ...
                <div>
                    <p>
                        Une erreur est survenue durant le paiement des frais de
